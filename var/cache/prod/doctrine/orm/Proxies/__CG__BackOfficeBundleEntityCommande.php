 ...
 */
class Commande extends \BackOfficeBundle\Entity\Commande implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Commande' . "\0" . 'id', '' . "\0" . 'BackOfficeBundle\\Entity\\Commande' . "\0" . 'dateCommande', '' . "\0" . 'BackOfficeBundle\\Entity\\Commande' . "\0" . 'etat', '' . "\0" . 'BackOfficeBundle\\Entity\\Commande' . "\0" . 'numeroCmde', '' . "\0" . 'BackOfficeBundle\\Entity\\Commande' . "\0" . 'client'];
        }
    ...
    public function setNumeroCmde($numeroCmde)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumeroCmde', [$numeroCmde]);

        return parent::setNumeroCmde($numeroCmde);
    }
    ...
    public function getNumeroCmde()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumeroCmde', []);

        return parent::getNumeroCmde();
    }
