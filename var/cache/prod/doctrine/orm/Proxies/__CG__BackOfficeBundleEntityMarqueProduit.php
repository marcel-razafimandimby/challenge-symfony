 ...
 */
class MarqueProduit extends \BackOfficeBundle\Entity\MarqueProduit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\MarqueProduit' . "\0" . 'id', '' . "\0" . 'BackOfficeBundle\\Entity\\MarqueProduit' . "\0" . 'marque', '' . "\0" . 'BackOfficeBundle\\Entity\\MarqueProduit' . "\0" . 'fournisseur'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MarqueProduit $proxy) {
